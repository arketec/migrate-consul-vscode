export default function () {
    return `export interface IMigrationClient {
        /**
         ...
         * @param value The migration literal value or a function to determine the value based on the existing value
         * @example: literal: {a: 1}
         * @example function: existingVal => existingVal + 1
         */
        ...
        /**
         * A callback function to run after execution
         * @param callback The callback function
         */
        callback<T = any>(callback: (value: any) => T): IMigrationClient;
        /**
         * Removes a value at the provided jsonpath
         */
        remove(): IMigrationClient;
        /**
         * Pushes a value to an array at the provided jsonpath
         * @param callback The callback function
         */
        push(val: any): IMigrationClient;
        /**
         * Pops last value from an array at the provided jsonpath
         * @param callback The callback function
         */
        pop(): IMigrationClient;
        /**
         * Splices a value into an array at the index (default 0) at the provided jsonpath
         * @param callback The callback function
         */
